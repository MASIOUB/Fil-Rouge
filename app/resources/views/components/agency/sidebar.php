        ...
        <div class="d-flex" id="wrapper">
                ...
                <div class="" id="sidebar-wrapper" style="background-color: #081f3e;">
                        ...
                        <div class="list-group list-group-flush my-3">
                                <a href="<?= createLink('agency') ?>" class="list-group-item list-group-item-action bg-transparent second-text active"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a>
                                <a href="<?= createLink('agency/user') ?>" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-user me-2"></i>Customers</a>
                ...
                <div class="page-content">
                        <?php
                        require_once dirname(__DIR__) . "/agency/navbar.php";
                        ?>