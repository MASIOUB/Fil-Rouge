...
<!-- login page -->
<section class="bg-section d-flex align-items-center" style="background-image: url(./images/solo-traveler.png);">
    <!-- <div class="overlay"></div> -->
    <div class="container text-dark login">
        <div class="row p-4 justify-content-center my-5">
            <div class="col-sm-10 col-12 p-5 gap-3 d-flex flex-column bg-white" style="border-radius: 20px;">
                ...
                <div class="d-flex flex-column flex-lg-row gap-3">
                    <div class="p-5 text-center text-white" style="border-radius: 20px; background-color: #077bd4;">
                        <h3>For Agencies</h3>
                    ...
                    <div class="p-3 text-center text-white" style="border-radius: 20px; background-color: #077bd4;">
                        <h3>For Travelers</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita et, recusandae nobis fugit modi quibusdam ea assumenda.</p>
